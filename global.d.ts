...
import { TimeAttribute } from 'waterline';
import { BaseModelservice } from './api/services/BaseModelService';
...
declare global {
    ...
    interface sequelizeModel<TInstance, TAttributes> extends Model<TInstance, TAttributes> {
        [key: string]: any;
    }
    ...
    //<models here>
    var User: sequelizeModel<User, User>;
    var Crime: sequelizeModel<Crime, Crime>;
    var Citizen: sequelizeModel<Citizen, Citizen>;
    var Device: sequelizeModel<Device, Device>
    var Mobile_users: sequelizeModel<Mobile_users, Mobile_users>
    //<services here>
    var UserService: Userservice;
    var BaseModelService: BaseModelservice;
